...
ggsave("Geral/DT_S1_CLOSED_Matrix.pdf") 
```
...
savePdf("S1/F_S1_OPEN_Results.pdf", results)
```
...
savePdf("S1/DT_S1_OPEN_Results.pdf", resultsOpen)
```
...
savePdf("S1/KNN_S1_OPEN_Results.pdf", resultsOpen)
...
plotConfusionMatrix(rand_fit, test)
ggsave("S2/RF_S2_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(rand_fit_open, testOpen)
ggsave("S2/RF_S2_OPEN_Matrix.pdf", width = 3, height = 3) 
...
plotConfusionMatrix(decision_fit, test)
ggsave("S2/DT_S2_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(decision_open_fit, testOpen)
ggsave("S2/DT_S2_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
plotConfusionMatrix(knn_fit, test)
ggsave("S2/KNN_S2_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(knn_fit_open, testOpen)
ggsave("S2/KNN_S2_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
plotConfusionMatrix(rand_fit, test)
ggsave("S3/RF_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(rand_fit_open, testOpen)
ggsave("S3/RF_S3_OPEN_Matrix.pdf", width = 3, height = 3) 
...
plotConfusionMatrix(decision_fit, test)
ggsave("S3/DT_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(decision_open_fit, testOpen)
ggsave("S3/DT_S3_OPEN_Matrix.pdf", width = 3, height = 3) 
```
```{r}
results = plotClassMetrics(predictKNN)
...
plotConfusionMatrix(knn_fit, test)
ggsave("S3/KNN_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(knn_fit_open, testOpen)
ggsave("S3/KNN_S3_OPEN_Matrix.pdf", width = 3, height = 3) 
```
