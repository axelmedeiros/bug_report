...
ggsave("Geral/DT_S1_CLOSED_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/RF_S1_CLOSED_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/KNN_S1_CLOSED_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/DT_S1_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/RF_S1_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/KNN_S1_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
ggsave("Geral/plataformeTendence.pdf", width = 3, height = 3) 
...
savePdf("DT_S2_OPEN_Results.pdf", results)

plotConfusionMatrix(decision_fit, test)
ggsave("DT_S2_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(decision_open_fit, testOpen)
ggsave("DT_S2_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
savePdf("KNN_S2_OPEN_Results.pdf", results)

plotConfusionMatrix(knn_fit, test)
ggsave("KNN_S2_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(knn_fit_open, testOpen)
ggsave("KNN_S2_OPEN_Matrix.pdf", width = 3, height = 3) 
```
...
```{r}
results = plotClassMetrics(predictRand)
savePdf("RF_S3_CLOSED_Results.pdf", results)

results = plotClassMetrics(predictRandOpen)
savePdf("RF_S3_OPEN_Results.pdf", results)

plotConfusionMatrix(rand_fit, test)
ggsave("RF_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(rand_fit_open, testOpen)
ggsave("RF_S3_OPEN_Matrix.pdf", width = 3, height = 3) 

```
```{r}
results = plotClassMetrics(predictDT)
savePdf("DT_S3_CLOSED_Results.pdf", results)

results = plotClassMetrics(predictDTOpen)
savePdf("DT_S3_OPEN_Results.pdf", results)

plotConfusionMatrix(decision_fit, test)
ggsave("DT_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(decision_open_fit, testOpen)
ggsave("DT_S3_OPEN_Matrix.pdf", width = 3, height = 3) 
```
```{r}
results = plotClassMetrics(predictKNN)
savePdf("KNN_S3_CLOSED_Results.pdf", results)

results = plotClassMetrics(predictKNNOpen)
savePdf("KNN_S3_OPEN_Results.pdf", results)

plotConfusionMatrix(knn_fit, test)
ggsave("KNN_S3_CLOSED_Matrix.pdf", width = 3, height = 3) 

plotConfusionMatrix(knn_fit_open, testOpen)
ggsave("KNN_S3_OPEN_Matrix.pdf", width = 3, height = 3) 
```
